 ...
 */
export async function executeCampaignWithServices(campaignTask, whatsAppClient, mainWindow) {
    ...
    try {
        ...
        // Execute campaign
        const result = await executor.execute(campaignTask, strategy, selectedServerId);
 ...
 */
export function pauseCurrentCampaign() {
    if (currentExecutor) {
 ...
 */
export function resumeCurrentCampaign() {
    if (currentExecutor) {
 ...
 */
export function stopCurrentCampaign() {
    if (currentExecutor) {
