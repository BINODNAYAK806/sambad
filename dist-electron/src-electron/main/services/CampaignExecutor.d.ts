...
import type { CampaignTask, ExecutionResult, SendingStrategy } from '../types/campaign';
...
export declare class CampaignExecutor {
     ...
     */
    execute(campaignTask: CampaignTask, strategy: SendingStrategy, designatedServerId?: number, runId?: number | null): Promise<ExecutionResult>;
    /**
