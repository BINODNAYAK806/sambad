...
exports.whatsappAdapter = exports.WhatsAppAdapter = void 0;
/**
...
class WhatsAppAdapter {
     ...
     */
    async initSession() {
        throw new Error('WhatsApp engine not activated. ' +
     ...
     */
    async login() {
        throw new Error('WhatsApp login not available. ' +
     ...
     */
    async logout() {
        throw new Error('WhatsApp logout not available. ' +
            'WhatsApp engine must be activated locally first.');
    }
    /**
    ...
    async startCampaign(params) {
        ...
        throw new Error('Campaign execution not available. ' +
     ...
     */
    async pauseCampaign() {
        throw new Error('Campaign control not available. ' +
            'WhatsApp engine must be activated locally first.');
    }
    /**
 ...
 */
exports.whatsappAdapter = new WhatsAppAdapter();
/**
 * Activation Guide
 *
